  ...
  return (
    <header className="relative flex min-h-[92svh] flex-col items-center justify-center overflow-x-hidden px-6 pb-16 pt-14 text-center">
      ...
      <div className="relative z-[1] mt-8 w-full max-w-[300px]">
        ...
        <motion.div
          className="relative z-10 -mt-[4.75rem] mx-3 rounded-xl border border-white/50 bg-white/70 px-5 py-5 shadow-[0_28px_70px_-30px_rgba(60,45,25,0.55)] backdrop-blur-sm sm:bg-white/60 sm:backdrop-blur-md"
